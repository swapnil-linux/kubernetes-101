...
```
$ kubectl get pods -n myapp -o yaml | head -20
apiVersion: v1
items:
- apiVersion: v1
  kind: Pod
...
```
$ kubectl describe pod hello-pod -n myapp
Name:         hello-pod
Namespace:    myapp
Priority:     0
...
```
$ kubectl create -f kubernetes-101/labs/pods/initpod.yml -n myapp
...
```
$ kubectl logs -n myapp initpod-demo -c init-con|more
Server:		10.96.0.10
...
```
$ kubectl create -f kubernetes-101/labs/pods/initsvc.yml -n myapp 
...
```
$ kubectl logs -n myapp initpod-demo -c init-con | tail -2
...
```
$ kubectl create -f kubernetes-101/labs/pods/sidecar.yml -n myapp
...
```
$ kubectl exec -n myapp git-sync -c webapp -- ls /usr/share/nginx/html/
README.md
SECURITY.md
abc.html
index.php
...
```
$ kubectl exec -n myapp git-sync -c syncapp -- ls /tmp/git/html/
README.md
SECURITY.md
abc.html
index.php
...
```
$ curl http://localhost:30001/abc.html
Hiiii
[centos@ip-10-0-2-94 ~]$ 
```
...
```
$ kubectl logs -n myapp git-sync -f -c syncapp
....
....
....
...
```
$ sudo crictl inspect 8db176b3e08c5 |grep pid
    "pid": 4465,
          "pids": {
            "type": "pid"
```
...
```
$ sudo crictl inspect b6b1def7b2eae |grep pid
    "pid": 4374,
          "pids": {
            "type": "pid"
[centos@ip-10-0-2-94 ~]$ 
